...
<html lang="en">
    <head>
        ...
        <title>코너디럭스 - Hidden Cliff Hotel and Nature</title>
        ...
        <div class="rsc-body-area">
            <div class="reservation-content-main">
                <!-- <nav class="kjh-page-list">
                    <a href="/">HOME</a> > <a href="/nav/rooms"> ROOMS</a> > <a href=""> 코너 디럭스</a>
                </nav>
            ...
            <div class="bsh-main-title">
                ...
                <div id = "slide-photo">
                    ...
                    <img src="/resources/image/nav/rooms/cornerDeluxe/cornerDeluxe1.jpg" id="slideImage">
                </div>
                <div class="kjh-sub-section">
                    <p class="kjh-content">
                    넉넉한 공간과 색다른 구조가 매력적인 코너 디럭스 룸에서는 특별한 여행의 추억이 쌓입니다.
                    </p>
                </div>
        	    ...
        	    <script src="/resources/js/nav/room/roomCornerDeluxe.js"></script>
