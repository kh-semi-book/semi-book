        ...
        <!-- =================================[ /header ]=================================== -->
                ...
                <div class="reservation-lookUp-page">
                    ...
                    <div class="rsc-head-area">
                        ...
                        <section class="rsc-body-TopArea">
                            ...
                            <!-- 페이지 제목 -->
                            <div class="rsc-page-title"><h1>인피니티풀</h1></div>
                        </section>
                        <section></section>
                    </div>
                <div class="rsc-body-area">
                    <div class="reservation-content-main">
                        ...
                        <p id="rsc-image-text">
                            국내 최대 47m를 자랑하는 인피니티 풀은 1년 365일 이용 가능한 사계절 온수풀입니다.<br>
                            제주도 원시림에 둘러싸인 채 지상에서 15m, 계곡에서 35m 떨어져 있어 마치 숲 속에서<br>
                            유영하는 듯한 이국적이고 색다른 분위기를 즐길 수 있습니다.<br>
                        </p>
                        </div>
                        ...
                        <p id="rsc-notification-p">· 인피니티 풀 및 인피니티 바 운영시간은 방역 지침에 따라 별도 안내 없이 변경될 수 있습니다.
                        </p>
                        </div>
                        ...
                        <table id="rsc-table-pool">
                            ...
                            <tr id="rsc-last-tr">
                                ...
                                <td colspan="4" width="140px" height="300px" id="table-content">
                                    <p id="table-content">
                                    · 인피니티 풀은 투숙객 전용 공간입니다. <br>
                                    · 분실 위험이 있는 귀중품은 객실에 보관해 주시기 바랍니다. <br>
                                    · 깨끗한 수질 관리를 위하여 샤워 후 입수 바라며 수영복 착용 후 이용 가능 합니다.<br>
                                    · 신장 1.3m 미만 어린이는 반드시 안전조끼 착용과 보호자 동반 입수 시 수영장 이용이 가능합니다. <br>
                                    · 수영장 내 위생과 안전을 위하여 아래 물품의 반입을 금지합니다.<br>
                                    &nbsp;&nbsp;- 외부 음식물, 금속이나 유리 등 깨질 수 있는 소재의 제품<br>
                                    &nbsp;&nbsp;- 1m 이상의 튜브(보트, 베드), 스노클, 핀(오리발), 운동화형 아쿠아슈즈, 드론<br>
                                    · 안전사고 예방을 위하여 난간 위에 앉거나 서는 행위는 삼가 바랍니다.<br>
                                    · 인피니티 풀의 전체 지역은 금연구역입니다.<br>
                                    · 폭우나 태풍 등 기상 악화 발생 시 인피니티 풀 입장 및 이용이 제한될 수 있습니다.<br>
                                    · 인피니티 풀 운영시간은 호텔 사정으로 인하여 변경될 수 있습니다.<br>
                                    </p>
                                </td>
                            </tr>
                                <tr>
