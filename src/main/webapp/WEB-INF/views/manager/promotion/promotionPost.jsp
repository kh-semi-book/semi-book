                ...
                <table id="board_table">
                    ...
                    <tr>
                        <th class="select-area">
                            ...
                            <input type="file" name="promotionTitleImage" id="inputTitleImg" accept="image/*"><button
                                type="button" class="deleteBtn">삭제</button>
                        </th>
                        <td colspan="3">
                    ...
                    <tr>
                        <th class="select-area">
                            ...
                            <input type="file" name="promotionConImage" id="inputConImg" accept="image/*">
                    ...
                    <tr>
                        <th>객실 전망 선택</th>
                        <td colspan="3">
                            <span><input type="checkbox" name="viewType" id="gardenView"><label for="gardenView">가든 뷰</label></span>
                            <span></span><input type="checkbox" name="viewType" id="cliffView"><label for="cliffView">클리프 뷰</label></span>
                            <span></span><input type="checkbox" name="viewType" id="panoramaView"><label for="panoramaView">파노라마 뷰</label></span>
                        </td>
                    </tr>
                    <tr>
                        <th>객실 타입 선택</th>
                        <td colspan="3">
                            <span><input type="checkbox" name="roomType" id="deluxe"><label for="deluxe">디럭스</label></span>
                            <span><input type="checkbox" name="roomType" id="cornerDeluxe"><label for="cornerDeluxe">코너 디럭스</label></span>
                            <span><input type="checkbox" name="roomType" id="familySuite"><label for="familySuite">패밀리 스위트</label></span>
                            <span><input type="checkbox" name="roomType" id="yeraeSuite"><label for="yeraeSuite">예래 스위트</label></span>
                        </td>
                    </tr>
