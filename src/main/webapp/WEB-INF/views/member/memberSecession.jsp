...
<title>회원 탈퇴</title>
<link rel="stylesheet" href="/css/myPage/member secession.css">
		...
		<div class="rsc-head-area">
			...
			<section class="rsc-body-TopArea">
				...
				<nav class="rsc-page-list">
					<a href="#">HOME</a> > <a href="#">마이페이지</a> > <a href="#">회원탈퇴</a>
				</nav>
				<!-- 페이지 제목 -->
		...
		<div class="rsc-body-area">
			...
			<div id="rsc-member-Notice">
				<p id="rsc-member-del-text">
					간단한 본인정보 확인후 회원탈퇴가 가능합니다. <br> 더 좋은 여행상품과 서비스를 제공하기 위해 노력하겠습니다.
				</p>
			</div>
