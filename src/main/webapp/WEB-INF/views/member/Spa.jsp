        ...
        <div class="reservation-lookUp-page">
          ...
          <div class="rsc-head-area">
            ...
            <section class="rsc-body-TopArea">
              ...
              <!-- 페이지 제목 -->
              <div class="rsc-page-title"><h1>보떼에르 스파 바이 록시땅</h1></div>
            </section>
          ...
          <div class="rsc-body-area">
              <div class="reservation-content-main">
                <!-- 중간 메인 영역 -->
                  <!-- 이미지 영역 -->
                  <img src="/image/new_spa4.jpg" width="1000px" height="550px">

                  <br><br>
                  <!-- SPA 설명 -->
                  <div id="rsc-SPA-info">
                    <p>
                      프랑스 프리미엄 레벨의 보떼에르 스파와 록시땅 스파가 만났습니다. <br>
                      프랑스 드롬 지방에서 온 작약부터 코르시카에서 온 이모르텔, 부르키나파소에서 온 시어버터의 천혜 원료와 <br>
                      보떼에르 스파 전문가들의 손끝으로 전해지는 두피를 중심으로 이루어지는 모든 케어 프로그램들은<br>
                      50년 전통의 케어비법으로 건강과 아름다움의 비밀을 당신에게 선사합니다. <br>
                    </p>
                  </div>
                  ...
                  <button id="rsc-menu-btn">
                    <a href="/image/spa_info.pdf">전체 메뉴 보기</a>
                  </button>
