...
<title>회원 가입</title>
<link rel="stylesheet" href="/css/myPage//member Signup.css">
			...
			<div id="rsc-member-Notice">
				...
				<section id="memberDelete_body_area">
					<div id="rsc-member-del-text">
						<h3>히든 클리프 호텔 & 네이쳐 회원이 되신걸 환영합니다.</h3>
						<br> <span> 공식 홈페이지에서만 예약 가능한 다양한 상품과 이벤트 혜택을 이용해 보시기 바랍니다. </span> <br>
						<br>
						<p>김연수님의 아이디는 raura98입니다.</p>
					</div>
					<br>
					<br>
					<!-- 버튼 -->
