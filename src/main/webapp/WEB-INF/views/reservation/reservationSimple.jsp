...
<link rel="stylesheet" href="/css/reservation/reservationSimple.css">
			...
			<div class="reservation-content-main">
				<table width="960px" id="table-room-view">
					<tr>
						...
						<th width="100px">금액<br>(VAT포함)
						</th>
						<th width="100px">진행상태</th>
					</tr>
					<tr>
						<td height="100px">2022-10-13</td>
						<td>[얼리버드] Hidden Earlybird <br>
							<button id="button-view-detail">
								<a href="/html/reservation/reservation- View Details.html">상세보기</a>
							</button>
						</td>
						<td>디럭스 더블 가든</td>
						<td>2023-01-12</td>
